...
public class EntityLightFX extends EntityFX {
    ...
    public EntityLightFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
        super(par1World, par2, par4, par6, par8, par10, par12);
        setParticleIcon(DataHandler.miningLight);
        ...
        this.particleRed = 0.84F;
        this.particleGreen = 0.625F;
